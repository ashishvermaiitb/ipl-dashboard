...
export default function LiveMatchCard() {
  const { data, isLoading, error, refetch } = useIPLData(30000); // Refresh every 30 seconds for live match
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex flex-col items-center space-y-6">
              ...
              <div className="text-sm text-gray-500">{nextMatch.venue}</div>
            </div>
          </CardContent>
        </Card>
      );
      ...
      <CardContent className="pt-4">
        <div className="flex flex-col md:flex-row justify-between gap-6">
          ...
          <div className="flex-1">
            ...
            {/* Venue */}
            <div className="mt-4 text-sm text-gray-500">{liveMatch.venue}</div>
            ...
            {liveMatch.requiredRunRate && (
              <div className="mt-4 p-3 bg-gray-50 rounded-md">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-xs text-gray-500">CURRENT RR</div>
                    <div className="font-bold">
                      {liveMatch.currentRunRate?.toFixed(2)}
                    </div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-500">REQUIRED RR</div>
                    <div className="font-bold">
          ...
          <div className="flex-1 border-t md:border-t-0 md:border-l border-gray-200 pt-4 md:pt-0 md:pl-6">
            ...
            {liveMatch.currentBatsmen &&
              liveMatch.currentBatsmen.length > 0 && (
                <div>
                  <h3 className="text-sm font-semibold mb-2">BATSMEN</h3>
            ...
            {liveMatch.currentBowler && (
              <div className="mt-4">
                <h3 className="text-sm font-semibold mb-2">BOWLER</h3>
            ...
            {liveMatch.recentOvers && liveMatch.recentOvers.length > 0 && (
              <div className="mt-4">
                <h3 className="text-sm font-semibold mb-2">RECENT OVERS</h3>
                <div className="space-y-2">
            ...
            {liveMatch.lastWicket && (
              <div className="mt-4">
                <h3 className="text-sm font-semibold mb-2">LAST WICKET</h3>
